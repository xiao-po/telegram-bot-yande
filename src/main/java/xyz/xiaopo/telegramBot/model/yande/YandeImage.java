package xyz.xiaopo.telegramBot.model.yande;
...
public class YandeImage {
    ...
    private List<YandeImageTag> tagList;
    ...
    public List<YandeImageTag> getTagList() {
        return tagList;
    }

    public void setTagList(List<YandeImageTag> tagList) {
